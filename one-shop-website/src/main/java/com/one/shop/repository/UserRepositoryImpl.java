...
public class UserRepositoryImpl {
    ...
    public List<UserEntity> findUserByPhoneOrNameOrEmail(String phone, String password) {
        ...
        for (Object[] objectList : objects) {
            ...
            String pointId = objectList[8]==null?null:String.valueOf(objectList[8]);
            String cashAccountId = objectList[9]==null?null:String.valueOf(objectList[9]);
            userEntity.setId(id);
            ...
            userEntity.setPointId(pointId);
            userEntity.setCashAccountId(cashAccountId);
