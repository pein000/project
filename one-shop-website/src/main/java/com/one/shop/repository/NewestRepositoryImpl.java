 ...
 */
@Repository
public class NewestRepositoryImpl {

    @PersistenceContext
    private EntityManager em;

    public List<GoodsEntity> findNewestByPage(int page,int size) {

        String sql = "select g.id as id ,g.name,g.description,g.outline_url,g.type,g.price,g.total_amount,g.cur_amount,n.id as tId,n.goods_id " +
                "from one_shop_goods g  join one_shop_newest n on g.id = n.goods_id limit "+page+" , "+size;
