 ...
 */
@Repository
public class RevealedRepositoryImpl {

    @PersistenceContext
    private EntityManager em;

    public List<GoodsEntity> findRevealedByPage(int page,int size) {

        String sql = "select g.id as id ,g.name,g.description,g.outline_url,g.type,g.price,g.total_amount,g.cur_amount,v.id as tId,v.goods_id " +
                "from one_shop_goods g  join one_shop_revealed v on g.id = v.goods_id limit "+page+" , "+size;
